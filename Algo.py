...
def initial_info():
    ...
    TimeF=st.text_input("⏰ Thời gian sự cố",placeholder="00 giờ 00 phút 00, ngày 01 tháng 01 năm 2025")
    ...
    comment = st.text_area("Ghi chú:",height=1)

    return TimeF, select_dz, phaF, F79, isc, weather, dis87, dis21, disFL, dis87N1, dis21N1, disFLN1,subs, df, comment
